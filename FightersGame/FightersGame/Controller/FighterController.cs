    ...
    private IFighterClass ChooseFighterClass()
    {
        ...
        while ( !isValidChoise )
        {
            ...
            string message = "Выберите класс:\n" +
                ...
                "5 - Паладин (Бонус здоровья: 60, Бонус урона: 6, Бонус брони: 5, Бонус инициативы: 1, Крит шанс: 0.08, Божественное исцеление (восстанавливает 10% здоровья за ход))\n";
    ...
    public IArmor ChooseArmor()
    {
        ...
        while ( !isValidChoise )
        {
            ...
            string message = "Выберите броню:\n" +
                ...
                "8 - Проклятая броня (Защита: 25, Эффект: Постепенно уменьшает здоровье владельца на 5 единиц)\n";
